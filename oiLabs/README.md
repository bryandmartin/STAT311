...
applied data analysis. Labs are titled based on topic area, which corrsepond to 
...
This repository is a fork of the original base-R labs. It incoporates 
the 'tidyverse' syntax from the `dplyr` package for data manipiulation, the `ggplot2` 
